      ...
      <Tabs.Screen 
        ...
        options={{
          tabBarIcon: ({ color, size = 24, focused }) => (
            <Icon name={focused ? "home" : "home-outline"} size={size || 24} color={color || '#808080'} />
          ),
        }}
      />
      <Tabs.Screen 
        ...
        options={{
          tabBarIcon: ({ color, size = 24, focused }) => (
            <Icon name={focused ? "chatbubble" : "chatbubble-outline"} size={size || 24} color={color || '#808080'} />
          ),
        }}
      />
      <Tabs.Screen 
        ...
        options={{
          tabBarIcon: ({ color, size = 24, focused }) => (
            <Icon name={focused ? "notifications" : "notifications-outline"} size={size || 24} color={color || '#808080'} />
          ),
        }}
      />
      <Tabs.Screen 
        ...
        options={{
          tabBarIcon: ({ color, size = 24, focused }) => (
            <Icon name="menu" size={size || 24} color={focused ? color || '#D4AF37' : color || '#808080'} />
          ),
        }}
      />
    </Tabs.Navigator>
    ...
    <SafeAreaProvider>
      <NavigationContainer theme={MatchmateTheme}>
        <Stack.Navigator 
          ...
          <Stack.Screen name="VerificationUpload" component={VerificationUploadScreen} />
